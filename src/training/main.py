...
def main_worker(gpu, ngpus_per_node, log_queue, args):
    ...
    if args.openai_pretrained:
        ...
        if args.default_aug:
            preprocess_train = _transform_default(512, is_train=True)
            preprocess_val = _transform_default(512, is_train=False)
        elif args.custom_aug:
            preprocess_train = _transform_custom(512, is_train=True)
            preprocess_val = _transform_custom(512, is_train=False)
        else:
