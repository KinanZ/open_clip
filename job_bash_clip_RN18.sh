#PBS -N clip_RN18_default_closs3_same_seed
#PBS -S /bin/bash
#PBS -l nodes=1:ppn=6:gpus=4:ubuntu2004:nvidiaGTX1080Ti,mem=32gb,walltime=24:00:00
#PBS -j oe
...
python3 /misc/student/alzouabk/Thesis/self_supervised_pretraining/open_clip/src/training/main.py \
  --name='clip_RN18_default_closs3_same_seed' \
  --save-frequency 49 \
